...
namespace MeusLivros_ProjetoMVC.Controllers
{
    public class AutoresController : Controller
    {
        ...
        public AutoresController(MeusLivros_ProjetoMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AutorId,NomeAutor,Nacionalidade")] Autor autor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AutorId,NomeAutor,Nacionalidade")] Autor autor)
        {
            if (id != autor.AutorId)
            {
                return NotFound();
