...
namespace MeusLivros_ProjetoMVC.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public EditorasController(MeusLivros_ProjetoMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EditoraId,NomeEditora")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EditoraId,NomeEditora")] Editora editora)
        {
