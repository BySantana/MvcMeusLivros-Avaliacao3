...
namespace MeusLivros_ProjetoMVC.Controllers
{
    public class StatusController : Controller
    {
        ...
        public StatusController(MeusLivros_ProjetoMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("StatusId,Mensagem")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StatusId,Mensagem")] Status status)
        {
